...
const Announcement = () => {
    return (
        <div className="bg-cover bg-center h-screen pt-16" style={{backgroundImage:`url(${backgroundimg})`}}>
            <div className="backdrop-blur-md p-6 w-2/3 mx-auto rounded-xl  border border-red-600 ">
